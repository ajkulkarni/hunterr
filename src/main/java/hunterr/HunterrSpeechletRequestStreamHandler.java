 ...
 * Lambda console to "scorekeeper.ScoreKeeperSpeechletRequestStreamHandler" For
...
public class HunterrSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler{
	...
	public HunterrSpeechletRequestStreamHandler() {
        super(new HunterrSpeechlet(), supportedApplicationIds);
    }
}
